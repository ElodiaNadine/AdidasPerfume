        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-3 flex-wrap">
            <button
              ...
              className={`px-4 py-2 rounded-full font-bold uppercase tracking-wide text-sm transition-all ${
                eventFilter === "All" 
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full font-bold uppercase tracking-wide text-sm flex items-center gap-2 transition-all ${
                eventFilter === "online" 
